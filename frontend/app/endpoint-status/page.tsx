        ...
        {summary && (
          <div className="grid grid-cols-3 md:grid-cols-6 gap-3 mb-6">
            <CompactStatCard
              ...
              tooltip="Total agents registered on-chain"
              icon={
            ...
            <CompactStatCard
              ...
              tooltip="Agents scanned for endpoints"
              icon={
            ...
            <CompactStatCard
              ...
              subtitle={`${summary.agents_with_endpoints > 0 ? ((summary.agents_with_working_endpoints / summary.agents_with_endpoints) * 100).toFixed(1) : 0}%`}
              tooltip="Agents with reachable endpoints"
              color="green"
              icon={
            ...
            <CompactStatCard
              ...
              tooltip="Agents with on-chain feedback"
              icon={
            ...
            <CompactStatCard
              ...
              subtitle={`${summary.healthy_endpoints} healthy`}
              tooltip="Total endpoint URLs found"
              icon={
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className="text-[#737373]">
            ...
            <CompactStatCard
              ...
              tooltip="Healthy endpoints percentage"
              color={summary.endpoint_health_rate >= 50 ? 'green' : 'red'}
              icon={
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className={summary.endpoint_health_rate >= 50 ? 'text-green-500' : 'text-red-500'}>
                  <path d="M22 12H18L15 21L9 3L6 12H2" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              }
            />
        ...
        {summary && (
          <div className="grid grid-cols-3 gap-3 mb-6">
            <CompactStatCard
              ...
              tooltip="All on-chain reputation feedbacks"
              color="purple"
              icon={
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className="text-purple-500">
            ...
            <CompactStatCard
              ...
              tooltip="Average score (0-100)"
              color={summary.avg_reputation_score && summary.avg_reputation_score >= 70 ? 'blue' : undefined}
              icon={
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className={summary.avg_reputation_score && summary.avg_reputation_score >= 70 ? 'text-blue-500' : 'text-orange-500'}>
            ...
            <CompactStatCard
              ...
              tooltip="Agents with feedback / total"
              icon={
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className="text-blue-500">
                  <path d="M22 12H18L15 21L9 3L6 12H2" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
      ...
      <div className="flex items-center gap-1.5 mb-1">
        ...
        {tooltip && (
          ...
          >
            ...
            {showTooltip && (
              <div className="absolute z-50 bottom-full right-0 mb-2 px-2 py-1.5 bg-[#0a0a0a] dark:bg-[#fafafa] text-white dark:text-[#0a0a0a] text-[10px] rounded-md shadow-lg w-40 leading-relaxed">
                {tooltip}
