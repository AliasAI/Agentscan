        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2 mb-6 text-[11px] text-[#737373]">
          ...
          {[
            ...
            <span key={d.label} className="relative group flex items-center gap-1.5 cursor-default">
              ...
              {d.label}
              <span className="pointer-events-none absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2.5 py-1.5 rounded-lg text-[11px] text-white bg-[#0a0a0a] dark:bg-[#fafafa] dark:text-[#0a0a0a] whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-150 shadow-lg">
                {d.tip}
              </span>
            </span>
          ))}
